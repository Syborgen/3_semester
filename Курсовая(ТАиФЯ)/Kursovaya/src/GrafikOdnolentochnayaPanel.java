...
public class GrafikOdnolentochnayaPanel extends JPanel{
    public static int toCount=0;
    public static int[] a={0,0};
    public java.util.List<VershinaOdnolentochnaya> vershiny = new ArrayList<>();

    public void add(VershinaOdnolentochnaya v){
        vershiny.add(v);
    }
    ...
    public void paintComponent(Graphics g) {
        ...
        System.out.println("GrafikOdnolentochnayaPanel: " + Thread.currentThread().getName());
